# Detect & delete Network load balancers if unused
...
```sh
flowpipe pipeline run detect_and_delete_network_load_balancers_if_unused_trigger --host local --arg='approvers=["default"]'
```
...
```sh
flowpipe pipeline run detect_and_delete_network_load_balancers_if_unused_trigger --arg='default_action="delete"'
```

However; if you have configured a non-empty list for your `approvers` variable, you will need to override it as below:

```sh
flowpipe pipeline run detect_and_delete_network_load_balancers_if_unused_trigger --arg='approvers=[]' --arg='default_action="delete"'
```
