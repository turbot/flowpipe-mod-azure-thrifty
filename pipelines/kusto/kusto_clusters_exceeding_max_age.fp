...
trigger "query" "detect_and_correct_kusto_clusters_exceeding_max_age" {
  ...
  documentation = file("./pipelines/kusto/docs/detect_and_correct_kusto_clusters_exceeding_max_age_trigger.md")
...
pipeline "detect_and_correct_kusto_clusters_exceeding_max_age" {
  title         = "Detect & correct Kusto clusters exceeding max age"
  description   = "Detects Kusto clusters exceeding max age and runs your chosen action."
  documentation = file("./pipelines/kusto/docs/detect_and_correct_kusto_clusters_exceeding_max_age.md")
  tags          = merge(local.kusto_common_tags, { class = "unused", type = "recommended" })
